...
### Installation instructions ###
  ...
  3. Rename `config.sample.php` file to `config.php` and adjust it with information related to your environment and GitLab projects that you want to keep in sync (see **Configuration** section). You can change "'apiUser' => $_GET['apiUser']," to "'apiUser' => '<Your ID>',", and "'apiPassword' => $_GET['apiPassword']" to "'apiPassword' => '<Your Password>'" or"'apiToken' => $_GET['apiToken']" to "'apiToken' => '<Your Token>'" if you want to use Token instead.
